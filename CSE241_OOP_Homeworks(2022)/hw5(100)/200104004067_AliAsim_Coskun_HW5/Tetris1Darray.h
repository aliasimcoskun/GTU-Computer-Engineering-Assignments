...
class Tetris1Darray : public Abstract
{
private:
    ...
    char* board; //the 1d array which holds board of tetris game
    char* animate_arr; //the 1d array which is using while animate process

public:
    Tetris1Darray() = delete; //constructor
    Tetris1Darray(const int row, const int column); //constructor with size of row and column
    virtual ~Tetris1Darray(); //destructor
