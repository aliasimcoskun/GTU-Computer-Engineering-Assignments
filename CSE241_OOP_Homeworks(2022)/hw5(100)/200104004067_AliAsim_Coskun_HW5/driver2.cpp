...
int main()
{
    ...
    string check_tetris_type;
    char tetris_type;
    cout << "Please enter type of the Tetris class\n(Enter '1' for 1Darray, 'V' for Vector, 'A' for adaptor): ";
    cin >> check_tetris_type;
    while(!((check_tetris_type[0]=='1' && check_tetris_type[1]=='\0') || (check_tetris_type[0]=='V' && check_tetris_type[1]=='\0') || (check_tetris_type[0]=='A' && check_tetris_type[1]=='\0')))
    {
        cout << "INVALID! Please try again: " << endl;
        cin >> check_tetris_type;
    }
    tetris_type=check_tetris_type[0];

    if(tetris_type=='1')
    {
        Tetris1Darray board(row, column); //creating board with given size
        ...
        board.readFromFile("OUTPUT.txt");
    }
    else if(tetris_type=='V')
    {
        TetrisVectorArray board(row, column); 
    ...
    else if(tetris_type=='A')
    {
        TetrisAdapter<vector<char>> board(row, column); 
